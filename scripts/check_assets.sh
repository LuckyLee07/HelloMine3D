...
require_file "menu artwork" "media/textures/WarmWildernessMenu.png"
require_file "HUD panel artwork" "media/textures/SandboxPanel.png"
require_file "HUD glyph artwork" "media/textures/SandboxGlyphs.png"
...
require_file "base food registry" "media/foods/Base.food"
