...
project "HelloMine3DRecipeSmoke"
    ...
    files {
        ...
        source_dir .. "/Item/SmeltingRegistry.h",
        source_dir .. "/Item/SmeltingRegistry.cpp",
        source_dir .. "/Item/ResourceEconomyVerifier.h",
        source_dir .. "/Item/ResourceEconomyVerifier.cpp",
