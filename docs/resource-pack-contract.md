...
`smelting`, `food` and `enemy` entries, but none is an allowed v1 override class. These
...
`HelloMine3DResourcePackSmoke` provides 27 isolated parser/resolver assertions:
