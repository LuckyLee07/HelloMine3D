...
权威验收边界见 `docs/ai-assisted-gameplay-acceptance-v1.md`。
...
`docs/todolist.md` 的下一批才是当前开发任务；后续 Track 必须由前一阶段暴露出的真实玩法或
...
```text
docs/architecture-lab/
    roadmap.md
    baseline/
        architecture-baseline-v1.md
        dependency-map-v1.md
        performance-baseline-v1.md
        ai-playability-baseline-v1.md
```
...
```text
00  从 Minecraft Clone 到 Sandbox Architecture
01  World / Chunk / Section / Coordinate
02  Block Registry 与 Data Driven Block
03  World Event System
04  Fixed Tick 与 Simulation System
05  Chunk State Machine
06  Async Streaming
07  Job Scheduler & Priority
08  Chunk Persistence
09  Dirty Propagation
10  Greedy Mesh

--------- 大世界 ---------

11  Render World 与 Simulation World
12  Chunk LOD
13  Far Terrain
14  Streaming Budget
15  Spatial Activation
16  Reduced Simulation

--------- 沙盒系统 ---------

17  Block Behavior Framework
18  Farming System
19  Machine Framework
20  Generic Network Graph
21  Create-style Mechanical Network
22  Belt / Transport
23  Machine Processing Graph
24  AE2-style Storage Network
25  Auto Crafting DAG

--------- 高级系统 ---------

26  Ability Composition
27  Procedural Structure
28  Entity Spawn System
29  AI LOD
30  World Debugger
31  Performance Profiling
32  Save Migration
33  Sandbox Architecture Capstone
```

其中现有 HelloMine3D 已经实现的内容，不要重写一遍。

教程应该采用：

> **现有实现 → 问题复盘 → 架构抽象 → 新系统扩展。**
...
| 06-07 | B2-B5 |
| 08 | D7 + 现有 Storage |
| 09-10 | 现有 Chunk 系统 + A2 |
| 11 | B7 |
| 12-13 | B8-B9 |
| 14-15 | B5-B6 |
| 16 | D2-D4 |
| 17-18 | 现有 Block Behavior + C1 |
| 19 | C2 |
| 20 | C3 |
| 21 | C4-C5 |
| 22 | C6 |
...
| 25 | C10 |
| 26 | 可选拓展 |
| 27 | 现有 Structure Generation 复盘 |
| 28 | 现有 Spawn System 复盘 |
| 29 | D5 |
| 30 | D8 |
| 31 | B10 + D8 |
| 32 | D7 |
| 33 | Autonomous Outpost |
...
```text
docs/architecture-lab/case-studies/

create-mechanical-network.md
ae2-storage-network.md
distant-horizons-lod.md
mekanism-machine-pipeline.md
ars-ability-composition.md
```
...
为 Architecture Lab 单独维护：

```text
docs/architecture-lab/provenance.md
```
