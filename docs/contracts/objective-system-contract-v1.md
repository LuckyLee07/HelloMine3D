...
当前冒险体验 B2a 将定义提升到 v4，保存重开改为可见可选项，面包提前至工作台，
熔炉与后段主线不再等待重开。34 个 ID 保持，可见必做 32；旧 v1／v2／v3 完成、进度、
未知 ID 和配方发现显式迁移，Alpha 十位门面独立保留。具体语义、验证及未完成范围见
[前期引导合同](adventure-onboarding-contract-v1.md)。上述 v1–v3 数字继续作为历史归属。
