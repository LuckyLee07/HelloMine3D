...
| `P11-2`（Queued） | terrain v4 身份与固定 seed；山地高度域/陡坡/洞口确定性；旧 v1-v3 世界不回填；新旧边界与结构重复；快速流送/规模玩法新身份 Q1。水文生成不进入本批。 | 在多个固定/随机种子实际寻找山地轮廓和可发现洞口；记录发现时间、可通行性、远景/阴影效果和新旧世界边界异常。 |
