...
路径已集中完成，R3 真人输入仍需目标机器上的操作者记录。之后的 Stage 9 / Beta 批次
已经预排但尚未开工，详细退出条件见 `docs/beta-gameplay-roadmap.md`。
...
| `BETA-RC` | Windows/macOS 适用全门禁、v1→最新全迁移、结局/奖励矩阵、战斗档案/投射物指标、结构/战利品快照、经济校验、语言/音频清理、Q1 正式比较、Q3 双档各 1800 秒、崩溃/符号/干净包。 | R3、许可证、伸缩项状态、产物新哈希、bundle 校验和本地 Beta 标签；不 push。 |
