...
本轮已将代码、工具、文档分批本地提交；同架构 v12 对照的 72 次、12 组性能全部通过，P95/P99 最大约 1.0273×/1.0363×。
用户已解锁 Mac，当前独立正常输入验收遇到 CUA 应用身份连接不一致；小窗口中英文 HUD/容器四项补验通过，原运行窗口保留 r3 状态，最新 r4 使用独立诊断包。
