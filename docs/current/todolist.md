...
新增顺岸风驱水面漂移已单独提交 `864c86e`：双配置世界各 1190/1190、资源各 112/112、GPU 与窗口冒烟通过；r5 前台性能完成 18/72 次、三组通过后按用户要求停止，完整动态/性能仍待补齐。
...
专用 r7 又修复表现时钟大增量/长会话精度：双配置计时各 5/5、物品各 8/8、地图各 10/10 通过；Full/Reduced/Off 共 96 帧后台动作检查通过，正常设置已恢复。历史 Reduced 停摆根因尚未证实，完整正常动作与后台性能待验。
