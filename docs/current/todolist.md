...
`Engineering Done / 窗口画面与性能待同次启动采集`：v1–v9 的 18 项生产采样/区块文件
...
[E4 执行记录](../reports/ecology-e4-inland-relief-v10-execution-2026-09-17.md)。尚未启动客户端，
下一步复用唯一项目 `.app` 一次启动完成画面与三轮性能。E2 的性能 FAIL 与 E3 延期的
正常玩法继续独立记录。
