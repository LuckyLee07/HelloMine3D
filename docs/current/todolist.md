...
**2026-09-22：冒险世界体验升级规划（Planned，实施尚未启动）。** 用户要求将天空与区域氛围、动物生态、探索目的地、前期成长、持久探索地图、整套界面及地下／玩家／声音扩展落地为文档和完整 Goal。已冻结 [迭代规划](adventure-experience-plan-2026-09-22.md) 与 [可执行 Goal](adventure-experience-goal-prompt-2026-09-22.md)：B0 基线 → B1 天空 → B2 前期任务 → B3 动物 → B4 目的地与建造 → B5 地图 → B6 界面 → B7 地下 → B8 玩家 → B9 声音 → B10 整合交付。全部方向均有最低交付及验收条件；编写文档不表示已完成实现或已启动宿主 Goal。启动后按该顺序替代下文历史目标的恢复顺序，已交付地形与 HUD 作为基础保留。
