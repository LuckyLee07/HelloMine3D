...
| 下一产品阶段已选定 | 第 8 阶段以“更像完整游戏”为主线。K4、G2-G6、Alpha 开发检查点以及 N1-N5 均已完成；当前进入 N6 产品体验。R3 与正式发行证据后置到主要 UI 稳定后集中执行。R4 已由独立的原生 TSan 门禁关闭。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 8 阶段 | 已启动，玩法闭环优先 | `K1-K4`、`G1-G6`、`N1-N5` 和 `H1` 已完成，玩家已具备目标引导、铁级成长、恢复、敌人掉落和路标探索循环；`Q2` 可移植计时采集已落地，`Q1` 已固定七类性能契约；当前推进 N6 产品体验，正式证据在综合封板阶段集中补齐。 |
...
| 13：产品体验（当前批次） | `N6` | UI 层级、配方可读性、键位与辅助选项、正式音效和低密度音乐。 | UI/输入稳定，失败提示可观察；R3 真人记录在功能冻结后执行。 | N5 已关闭，可以开始。 |
| 14：Release Candidate | `H2-H3`、`Q1-Q3`、`R3/R5` | 功能冻结后完成诊断、性能、长稳、迁移和干净包证据。 | 双配置全门禁、受控 dump、预算、soak、真人输入和发行包全部通过。 | N1-N6 冻结，只修缺陷。 |
...
| N6 产品体验（当前） | 键位、辅助选项、UI 统一、配方/目标可读性、正式音效和低密度音乐。 | N5 已冻结生成身份，主要玩法结构不再大改；之后执行 R3 和最终封板。 |
...
| M6 可持续游玩与可靠发布 | 已启动，玩法闭环优先 | K1-K4、G1-G6、N1-N5、H1 已完成，当前继续 N6，再集中取得 R3、H2-H3、Q1-Q3 和发行证据。 |
