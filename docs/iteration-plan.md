...
| 下一产品阶段已选定 | 第 8 阶段、Stage 9/N7-N12、BETA-RC 与 Stage 10/VISUAL-RC Windows 工程均已完成；人工输入、正式产品体验和 macOS 原生证据继续延期。下一步是产品方向评审，详细范围见 `docs/visual-quality-roadmap.md`。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| M8 视觉质量升级 | Windows 工程完成，macOS/产品体验 Verify | V10A 顶点光照/AO、V10B1-B3 材质/生态表现、V10C 大气云层、V10D 可选阴影、V10E 轻量后处理与 VISUAL-RC Windows 工程封板已完成；下一步为产品方向评审。 |
