...
| 下一产品阶段已选定 | 第 8 阶段以“更像完整游戏”为主线。K4、G2-G6、Alpha 开发检查点以及 N1 目标、N2 熔炉/铁级、N3 食物恢复均已完成；下一批推进 N4 战斗、敌人与掉落，之后是生态和体验。R3 与正式发行证据后置到主要 UI 稳定后集中执行。R4 已由独立的原生 TSan 门禁关闭。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 11：战斗、敌人与掉落（下一批） | `N4` | 近战攻击节奏、至少两类可读敌人差异、有界数据驱动掉落和目标接入。 | 失败攻击、冷却、重复死亡、卸载重载和掉落领取均守恒；定向双配置回归通过。 | N2/N3 已提供武器、恢复和存档边界。 |
...
| N4 战斗与掉落（下一批） | 武器、敌人差异、攻击节奏和有界掉落奖励。 | N2/N3 已提供准备和恢复手段。 |
...
| M6 可持续游玩与可靠发布 | 已启动，玩法闭环优先 | K1-K4、G1-G6、N1-N3、H1 已完成，H2 骨架、Q2 可移植采集与 Q1 合同已落地；下一批推进 N4 战斗与掉落，之后继续 N5-N6，并集中取得 R3、H2-H3、Q1-Q3 和发行证据。 |
