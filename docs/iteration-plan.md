...
| 第 8 阶段 | 已启动，玩法闭环优先 | `K1-K3` 世界目录/事务保存/备份恢复合同、`G1` 配方注册表、`H1` Windows 本地 minidump 已完成，`Q2` 可移植计时采集已落地，`Q1` 已固定六类性能契约；当前先推进 `K4`、`G2-G6`，`R3`、`H2-H3`、`Q1-Q3` 的正式证据在综合封板阶段集中补齐。 |
