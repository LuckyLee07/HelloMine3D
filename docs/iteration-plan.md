...
| 下一产品阶段已选定 | 第 8 阶段、Stage 9/N7-N12 与 BETA-RC 工程均已完成；人工输入和产品体验继续延期。Stage 10 的 V10A/V10B1 已完成 Windows 工程范围，当前进入 V10B2 原创材质资产，再按 V10B3、V10C-V10E 推进，详细范围见 `docs/visual-quality-roadmap.md`。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 10 阶段 | 进行中：V10B2 | `V10A`、`V10B1-B3`、`V10C-V10E` 与 `VISUAL-RC` 不计入当前 77 项总账；V10A 已按所有者批准的性能例外关闭，V10B1 Windows 工程与画面证据已关闭、macOS shader 子状态保持 Verify，当前按视觉路线启动 V10B2。 |
...
| 3 | V10B2 原创材质资产（In Progress） | L | 原创分面材质与世界/HUD/手持一致性。 | 生成脚本、来源、许可、manifest、资源包和近/中景开发者检查。 |
...
| M8 视觉质量升级 | In Progress：V10B2 | V10A 顶点光照/AO 与 V10B1 材质参数管线已完成 Windows 工程范围；当前推进原创分面材质，后续按生态变体、大气云层、可选阴影、轻量后处理和 VISUAL-RC 顺序关闭，开发者视觉检查与正式人工验收分层记录。 |
