...
| 下一产品阶段已选定 | 第 8 阶段以“更像完整游戏”为主线。K4 世界入口、G2 制作闭环和 G3 工具成长已完成，下一主线为 G4-G6；崩溃诊断和性能预算作为跟随护栏，R3 与正式发行证据后置到综合封板。R4 已由独立的原生 TSan 门禁关闭。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 8 阶段 | 已启动，玩法闭环优先 | `K1-K4`、`G1-G3` 和 `H1` 已完成，玩家已能管理世界、制作工作台与两级工具，并通过渐进采集解锁铁矿；`Q2` 可移植计时采集已落地，`Q1` 已固定六类性能契约；当前推进 `G4-G6`，正式证据在综合封板阶段集中补齐。 |
...
| M6 可持续游玩与可靠发布 | 已启动，玩法闭环优先 | K1-K4、G1-G3、H1 已完成，Q2 可移植采集与 Q1 合同已落地；继续交付 G4-G6，再集中取得 R3、H2-H3、Q1-Q3 和发行证据。 |
