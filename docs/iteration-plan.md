...
| 下一产品阶段已选定 | 第 8 阶段、Stage 9/N7-N12、BETA-RC 与 Stage 10/VISUAL-RC Windows 工程均已完成；Stage 11 的 P11-0/P11A 工程已完成，P11B 是下一开发批次。真人输入/试玩统一后置为 Deferred，正式产品体验和 macOS 原生证据继续保持 Verify；多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 11 阶段 | P11-0/P11A Engineering Done；P11B Planned；其余 Queued | 可玩性与操作体验路线不计入当前 77 项总账；可制造光源与核心输入工程已完成。后续工程按固定顺序推进，Physical Input v2、试玩和活动桌面证据统一保留 Deferred。 |
...
| 3 | P11B 动作反馈（Planned） | M | 手/工具、裂纹、粒子、命中/受击/冷却、拾取和音频微变体。 | 反馈不改变玩法判定；不混入敌人掉落经济；镜头类效果可调/可关；低配路径保持可读。 |
...
| M9 可玩性与操作体验 | P11-0/P11A Engineering Done；P11B Planned | 可制造光源、输入动作仲裁、settings v7 鼠标/模式与焦点状态机已完成；后续按工程顺序继续，真人/Q1/产品体验保留 Deferred 清单。 |
