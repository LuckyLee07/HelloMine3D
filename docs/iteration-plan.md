...
> `docs/ai-assisted-gameplay-acceptance-v1.md` 的 AI/Computer Use 场景；人类主观与物理体验
...
现按 `docs/ai-assisted-gameplay-acceptance-v1.md` 映射为 AI 场景和 `NOT_CLAIMED` 边界。
...
| AI/Computer Use | 按 `docs/ai-assisted-gameplay-acceptance-v1.md` 从干净 Release 包运行 `AI-01..AI-08`；禁止 fixture、传送、注入和存档编辑。 |
