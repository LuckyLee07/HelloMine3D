...
| 下一产品阶段已选定 | 第 8 阶段、Stage 9/N7-N12 与 BETA-RC 工程均已完成；人工输入和正式产品体验继续延期。Stage 10 的 V10A/V10B1/V10B2 已完成，当前按 V10B3、V10C-V10E 推进，详细范围见 `docs/visual-quality-roadmap.md`。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 10 阶段 | V10B3 Planned | `V10A`、`V10B1-B3`、`V10C-V10E` 与 `VISUAL-RC` 不计入当前 77 项总账；V10A 已按所有者批准的性能例外关闭，V10B1 Windows 工程与画面证据已关闭、macOS shader 子状态保持 Verify；V10B2 自动证据和授权审阅者静态视觉检查均已通过。 |
...
| M8 视觉质量升级 | V10B3 Planned | V10A 顶点光照/AO、V10B1 材质参数管线与 V10B2 原创分面材质已完成；当前按生态变体、大气云层、可选阴影、轻量后处理和 VISUAL-RC 顺序关闭。 |
