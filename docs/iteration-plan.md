...
| 下一产品阶段已选定 | 第 8 阶段以“更像完整游戏”为主线。K4、G2-G6、Alpha 开发检查点以及 N1-N6 均已完成；当前进入 Release Candidate，集中处理 R3、H2-H3、Q1-Q3 和最终发行证据。R4 已由独立的原生 TSan 门禁关闭。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 8 阶段 | 已进入发行候选封板 | `K1-K4`、`G1-G6`、`N1-N6` 和 `H1` 已完成，目标、成长、恢复、战斗掉落、生态探索及可访问体验层均已串联；`Q2` 可移植计时采集已落地，`Q1` 已固定七类性能契约；当前集中补齐诊断、性能、长稳、人工输入和发行证据。 |
...
| 14：Release Candidate（当前） | `H2-H3`、`Q1-Q3`、`R3/R5` | 功能冻结后完成诊断、性能、长稳、迁移和干净包证据。 | 双配置全门禁、受控 dump、预算、soak、真人输入和发行包全部通过。 | N1-N6 已冻结，只修缺陷。 |
...
| M6 可持续游玩与可靠发布 | 已进入 Release Candidate | K1-K4、G1-G6、N1-N6、H1 已完成，当前集中取得 R3、H2-H3、Q1-Q3 和最终发行证据。 |
