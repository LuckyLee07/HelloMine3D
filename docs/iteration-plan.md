...
| 下一产品阶段已选定 | 第 8 阶段以“更像完整游戏”为主线。K4 世界入口和 G2 制作闭环已完成，下一主线为 G3-G6；崩溃诊断和性能预算作为跟随护栏，R3 与正式发行证据后置到综合封板。R4 已由独立的原生 TSan 门禁关闭。多人、脚本化 mod、热更新和新渲染后端仍未立项。 |
...
| 第 8 阶段 | 已启动，玩法闭环优先 | `K1-K4`、`G1-G2` 和 `H1` 已完成，玩家已能管理世界并通过 2×2/工作台 3×3 正常制作；`Q2` 可移植计时采集已落地，`Q1` 已固定六类性能契约；当前推进 `G3-G6`，正式证据在综合封板阶段集中补齐。 |
