...
| Isolated distribution | Latest seed-width candidate ZIP a006b55c passes 106 inventory hashes /107 exact files; prior first-layout AppleDouble membership failure retained; earlier outside-repo preflight has its recorded revision | Package integrity/startup proven; not proof of blind executor isolation |
