...
2026-09-12 使用当前干净包再次从正常菜单创建 terrain v5 世界、保存重开，并完成双语三缩放
实现者界面自测；短按移动时受敌击退影响，仍不能证明受控步行，库存为空。详情见
[M1/T1 补验](m1-t1-acceptance-continuation-2026-09-12.md)，不改变路线 `BLOCKED` 状态。
