...
P11-0、P11A、P11B 与 P11-1 已完成工程范围，当前计划开发批次为 P11C 前 30 分钟重构；其余批次按固定顺序排队。
...
| 玩法数据层 | G1-G6、N1-N6、N7A-N12C、BETA-RC 与 Stage 10/VISUAL-RC 均已完成 Windows 工程范围；Stage 11 的 P11-0/P11A/P11B/P11-1 工程已完成，P11C 是下一开发批次。 |
...
D4/D6 和 Stage 9/10 的全部人工体验。Stage 11 新增九个不回写历史统计的批次：P11-0/P11A/P11B/P11-1 为
`Engineering Done`，P11C 为 `Planned`，其余四批为 `Queued`。2026-08-28 的内容与视觉复核在原有六批之间插入了 P11-0、
...
| Stage 11 工程已完成 | 4 | P11-0 世界光源与洞穴照明、P11A 核心操作手感、P11B 动作反馈、P11-1 建造材料与工具分化（人工/Q1/动态观感子项 Deferred） |
| Stage 11 下一批 | 1 | P11C 前 30 分钟重构（Planned） |
| Stage 11 已排队 | 4 | P11D 探索奖励、P11-2 地形轮廓与洞口、P11E 敌人表现、P11F PLAYABILITY-RC |
...
| P11C 前 30 分钟重构 | Planned | P0 | 建造、成长、探索并行循环，至少两个可见可选目标和自然配方发现。 | 新世界前 30 分钟真人试玩没有长时间目标空白，并出现至少两项有意义的并行选择；首版不强推饥饿。 |
...
产品方向评审已选择 Stage 11，P11-0/P11A/P11B/P11-1 工程已关闭，下一开发批次为 P11C；macOS 原生与正式产品体验保持 Verify。
以上新增批次
仍不回写拆分前 77 项历史总账。
