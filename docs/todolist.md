...
| ID | Status | Task | Validation |
| -- | ------ | ---- | ---------- |
| W1 | Todo | Add a simple time-of-day and fog parameter channel without rewriting stored sunlight. | Deterministic headless assertions cover the cycle and shader-facing values; Windows Debug/Release client validation and a hardware capture show the visual transition. |
