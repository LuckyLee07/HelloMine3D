...
| 玩法数据层 | G1-G6、N1-N6、N7A/N7B、N8A/N8B、N9A/N9B 与 N10 已完成；当前下一批为 N11A 难度档案。 |
...
| 当前 Windows 门禁 | 2026-08-25 N10 完整通过 49 项资源、36 个性能夹具、R3 部分自测/其余延期记录、VS2017/v141 双配置定向目标、Debug/Release 0 错误全量重建、十三目标测试、隐藏客户端、131,009 字节后台受控 dump 和 69 文件干净发行包；ZIP SHA-256 为 `A39BFAE92E25775A461DD7251A9D48DF15067812287650CCE65E72EA448050AD`。 |

## 进度摘要

拆分前总账共有 77 个正式任务；历史总账仍为 73 个 `Done`、4 个 `Verify`。新增的 Stage 9
批次不回写该统计：`FS1-FS3`、`N7A/N7B`、`N8A/N8B`、`N9A/N9B` 与 `N10` 当前为 `Done`，
`N11-N12` 保持 `Planned`。
...
| Stage 9 已完成 | 10 | FS1 首次进入正确性、FS2 天空/水面/颜色、FS3 体素美术/HUD、N7A 结局状态与文本键基础、N7B 路标胜利闭环、N8A 战斗可读性、N8B 远程敌人与投射物、N9A 确定性结构框架、N9B 遗迹/营地与生态战利品、N10 食物/冶炼/资源经济 |
...
下列批次已经落成可回归路线，`FS1-FS3`、`N7A/N7B`、`N8A/N8B`、`N9A/N9B` 与 `N10` 已转成
