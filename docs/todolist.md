...
| 玩法数据层 | G1-G6、N1-N3 已完成：严格配方、制作、木/石/铁工具成长、暂停设置、基础音频、十步 Alpha 旅程、数据驱动目标、熔炉冶炼和食物恢复已经串联；下一批进入战斗、敌人与掉落纵深。 |
...
正在推进；H3、Q3 尚未开始。Alpha 开发检查点、N1-N3 已关闭，下一批进入 N4 战斗、
敌人与掉落纵深。
...
| 8：内容扩展（下一批 N4） | `N1-N6` | N1 目标引导、N2 熔炉/铁级和 N3 食物恢复已完成；下一步做战斗、敌人与掉落纵深，再推进生态和产品体验。 | 每项内容必须进入目标、成长或战斗循环；N4 必须复用武器实例、恢复资源、演员保存和目标事件边界。 |
...
熔炉/铁级成长与食物恢复已由 N1-N3 交付；战斗、生态和体验批次按
