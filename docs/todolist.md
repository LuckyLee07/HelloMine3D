...
| 玩法数据层 | G1-G6、N1-N6 已完成：目标、熔炉/铁级、食物恢复、差异化敌人/掉落、terrain v2 路标探索和产品体验层已经串联；当前进入 Release Candidate 封板。 |
...
正在推进；H3、Q3 尚未开始。Alpha 开发检查点和 N1-N6 已关闭，当前进入 Release Candidate。
...
| 9：发行候选封板（当前） | `R3`、`H2-H3`、`Q1-Q3` | 真人输入、dump/sidecar/符号化、崩溃提示、最终预算、压力/soak、迁移和干净包。 | 关闭 D2/D4/D6；目标 Windows Release 和发行包满足全部门禁。 |
