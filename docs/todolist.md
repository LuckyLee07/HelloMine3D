...
| 玩法数据层 | G1-G3 已完成：严格配方、玩家/工作台制作、木镐/石镐成长、渐进采集和耐久存档已经串联。 |
...
拆分前总账共有 77 个正式任务；计入本轮 G3 后为 65 个 `Done`、4 个 `Verify`、2 个
`Doing`、6 个 `Todo`。第 8 阶段的 16 项任务中，K1-K4、G1-G3 和 H1 已完成；Q1、Q2
正在推进；其余 6 项尚未开始。

| 类型 | 数量 | 任务 |
| ---- | ---- | ---- |
| 已完成的第 8 阶段底座与玩法 | 8 | K1、K2、K3、K4、G1、G2、G3、H1 |
| 已实现但未正式闭环 | 2 | Q1、Q2 |
| 等待最终验收 | 4 | D2、D4、D6、R3 |
| 尚未开始 | 6 | H2、H3、Q3、G4、G5、G6 |
