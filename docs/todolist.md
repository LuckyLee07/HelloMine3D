...
拆分前总账共有 77 个正式任务；计入本轮 G4 后为 66 个 `Done`、4 个 `Verify`、2 个
`Doing`、5 个 `Todo`。第 8 阶段的 16 项任务中，K1-K4、G1-G4 和 H1 已完成；Q1、Q2
正在推进；其余 5 项尚未开始。
