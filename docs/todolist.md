...
| 玩法数据层 | G1-G6 已完成：严格配方、玩家/工作台制作、木镐/石镐成长、渐进采集、耐久存档、暂停、版本化设置、基础音频和十步 Alpha 旅程已经串联。 |
...
正在推进；H3、Q3 尚未开始。Alpha 开发检查点已关闭，当前进入 N1 目标与首轮引导。
...
| 8：内容扩展（当前 N1） | `N1-N6` | 先做目标引导和熔炉/铁级，再推进食物恢复、战斗、生态和产品体验。 | 每项内容必须进入目标、成长或战斗循环；当前先以 N1 迁移 G6 一次性旅程。 |
