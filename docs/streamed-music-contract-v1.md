...
> Architecture Lab 迁移说明（2026-08-31）：工程与自动证据保持冻结；暂停、切世界、静音和
> 退出过渡功能映射到 `AI-07`，人类听感与音乐偏好为 `NOT_CLAIMED`。
...
历史真人听感没有形成 PASS。实际暂停/切世界/静音/退出的可观察功能映射到 `AI-07`，真实
无设备降级按未来明确批准的目标机器验证；人类听感和音乐偏好为 `NOT_CLAIMED`。自动格式与
生命周期测试仍不能替代真实窗口功能。
