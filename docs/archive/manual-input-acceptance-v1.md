...
> 物理操作者填写 PASS。功能子集迁移到 `docs/current/ai-assisted-gameplay-acceptance-v1.md`，物理
> 设备手感统一为 `NOT_CLAIMED`。
...
Physical Input v2 is defined by `docs/archive/physical-input-acceptance-v2.md` and adds
...
3. Copy `docs\archive\manual-input-record-v1.template.txt` to an evidence file outside
