...
以 `docs/archive/beta-gameplay-roadmap.md` 为准。
FS1-FS3 的权威兼容和验收边界见 `docs/contracts/first-session-visual-baseline-contract-v1.md`；当前功能和
...
`docs/reports/playability-release-candidate-report-2026-08-31.md`；当前没有后续已批准代码批次。自动测试负责回归，
