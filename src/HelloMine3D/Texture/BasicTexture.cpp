...
void BasicTexture::loadFromImage(const sf::Image& i)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, i.getSize().x, i.getSize().y, 0, GL_RGBA,
                 GL_UNSIGNED_BYTE, i.getPixelsPtr());
...
{
    sf::Image i;
    if (!i.loadFromFile(ResourcePaths::media("textures/" + file + ".png")))
    {
