...
namespace
{
    ...
    void RenderDrawLists(ImDrawData* draw_data)
    {
        ...
        assert(io.Fonts->TexID.GetTexID() !=
               ImTextureID_Invalid); // You forgot to create and set font texture
#else
            ...
            for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
            {
                ...
                else
                {
                        ...
                        clip_rect.w >= 0.0f)
                    {
                        ...
                        // Bind texture, Draw
#if IMGUI_VERSION_NUM >= 19200
                        const ImTextureID textureID = pcmd->GetTexID();
#else
                        const ImTextureID textureID = pcmd->TextureId;
#endif
                        const GLuint textureHandle = convertImTextureIDToGLTextureHandle(textureID);
